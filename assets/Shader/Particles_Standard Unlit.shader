...
SubProgram "d3d11 " {
Keywords { "FOG_EXP2" "_ALPHABLEND_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Keywords { "FOG_EXP2" "PROCEDURAL_INSTANCING_ON" "_ALPHABLEND_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Keywords { "FOG_LINEAR" "PROCEDURAL_INSTANCING_ON" "SOFTPARTICLES_ON" "_ALPHABLEND_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Keywords { "FOG_EXP2" "SOFTPARTICLES_ON" "_ALPHABLEND_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Keywords { "FOG_EXP2" "PROCEDURAL_INSTANCING_ON" "SOFTPARTICLES_ON" "_ALPHABLEND_ON" }
"// shader disassembly not supported on DXBC"
}
}
Program "fp" {
