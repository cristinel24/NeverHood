...
//
///////////////////////////////////////////
Shader "Universe/PolkaPattern" {
Properties {
_Texture ("Texture", 2D) = "white" { }
_GradientEmissive ("GradientEmissive", 2D) = "white" { }
_Texture_SpeedX ("Texture_SpeedX", Float) = 0.25
_Texture_TilingX ("Texture_TilingX", Float) = 1
_Texture_TilingY ("Texture_TilingY", Float) = 1
_Texture_OffsetX ("Texture_OffsetX", Float) = 0
...
_Texture_OffsetY ("Texture_OffsetY", Float) = 0
_Texture_Time ("Texture_Time", Float) = 0
