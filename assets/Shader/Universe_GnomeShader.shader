...
//
///////////////////////////////////////////
Shader "Universe/GnomeShader" {
Properties {
_Texture ("Texture", 2D) = "white" { }
_EmissivePower ("EmissivePower", Float) = 2
_Trance ("Trance", Float) = 1
_EmissiveTrigger ("EmissiveTrigger", Float) = 2
_TilingY ("TilingY", Float) = 0
_Rows ("Rows", Float) = 0
_Columns ("Columns", Float) = 4
_TilingX ("TilingX", Float) = 4
_OffsetFrame ("OffsetFrame", Float) = 8
_FlipbookSpeed ("FlipbookSpeed", Float) = 0
_TextureSample1 ("Texture Sample 1", 2D) = "white" { }
_Gradient_SpeedX ("Gradient_SpeedX", Float) = 0.25
_PannerSpeedX ("PannerSpeedX", Float) = 0
_Gradient_SpeedY ("Gradient_SpeedY", Float) = 0.25
_PannerSpeedY ("PannerSpeedY", Float) = 0
