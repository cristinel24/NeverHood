...
//
///////////////////////////////////////////
Shader "Flowers/SpiralFlower" {
Properties {
_Cutoff ("Mask Clip Value", Float) = 0.5
_TextureSample0 ("Texture Sample 0", 2D) = "white" { }
_Color0 ("Color 0", Color) = (1,0,0.9007449,0)
_Width ("Width", Float) = 0.4
_Number ("Number", Float) = 1
_MultiplierTempo ("MultiplierTempo", Float) = 2
_Separation ("Separation", Float) = 1
_MultiplierExponitional ("MultiplierExponitional", Float) = 1
