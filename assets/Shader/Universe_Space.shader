...
//
///////////////////////////////////////////
Shader "Universe/Space" {
Properties {
_MasterMultiply ("MasterMultiply", Float) = 0
_EmissionBoost ("EmissionBoost", Float) = 1
_Smoothness ("Smoothness", Float) = 0
_Metallic ("Metallic", Float) = 0.5
_1Cloud ("1Cloud", 2D) = "white" { }
_3Cloud ("3Cloud", 2D) = "white" { }
_2Cloud ("2Cloud", 2D) = "white" { }
_1Space ("1Space", 2D) = "white" { }
_3Space ("3Space", 2D) = "white" { }
_2Space ("2Space", 2D) = "white" { }
_1SpaceColor ("1SpaceColor", Color) = (1,1,1,1)
_1SpaceEmissionPower ("1SpaceEmissionPower", Float) = 1
_1SpaceTiling ("1SpaceTiling", Float) = 1
_1SpaceSpeed ("1SpaceSpeed", Vector) = (1,1,0,0)
_1CloudOffset ("1CloudOffset", Vector) = (1,1,0,0)
_1SpaceCloudContrast ("1SpaceCloudContrast", Float) = 0
_1SpaceCloudMultiplier ("1SpaceCloudMultiplier", Float) = 0
_1SpaceCloudTiling ("1SpaceCloudTiling", Float) = 1
_1SpaceCloudSpeed ("1SpaceCloudSpeed", Vector) = (1,1,0,0)
_2SpaceColor ("2SpaceColor", Color) = (1,1,1,1)
_2SpaceEmissionPower ("2SpaceEmissionPower", Float) = 1
_2SpaceTiling ("2SpaceTiling", Float) = 1
_2SpaceCloudTiling ("2SpaceCloudTiling", Float) = 1
_2SpaceCloudContrast ("2SpaceCloudContrast", Float) = 0
_2SpaceCloudMultiplier ("2SpaceCloudMultiplier", Float) = 0
_2SpaceCloudSpeed ("2SpaceCloudSpeed", Vector) = (1,1,0,0)
_2CloudOffset ("2CloudOffset", Vector) = (1,1,0,0)
_2SpaceSpeed ("2SpaceSpeed", Vector) = (1,1,0,0)
_3SpaceTiling ("3SpaceTiling", Float) = 1
_3SpaceColor ("3SpaceColor", Color) = (1,1,1,1)
_3SpaceSpeed ("3SpaceSpeed", Vector) = (1,1,0,0)
_3SpaceEmissionPower ("3SpaceEmissionPower", Float) = 1
_3CloudOffset ("3CloudOffset", Vector) = (1,1,0,0)
_3SpaceCloudContrast ("3SpaceCloudContrast", Float) = 0
_3SpaceCloudMultiplier ("3SpaceCloudMultiplier", Float) = 0
_3SpaceCloudTiling ("3SpaceCloudTiling", Float) = 1
_3SpaceCloudSpeed ("3SpaceCloudSpeed", Vector) = (1,1,0,0)
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
SubShader {
