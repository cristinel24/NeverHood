...
//
///////////////////////////////////////////
Shader "Flowers/RGBFlowers" {
Properties {
_TextureSample0 ("Texture Sample 0", 2D) = "white" { }
_RedTime ("RedTime", Float) = 1
_GreenTime ("GreenTime", Float) = 1
_GreenMultiplier ("GreenMultiplier", Float) = 1
_GreenAdd ("GreenAdd", Float) = 1
_GreenMax ("GreenMax", Float) = 1
_BaseColor ("BaseColor", Color) = (0.1394851,1,0,0)
_ColorOveride ("ColorOveride", Color) = (1,1,1,1)
_ColorOveride2 ("ColorOveride2", Color) = (1,1,1,1)
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
SubShader {
