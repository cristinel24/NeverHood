...
_Texture2_SpeedY ("Texture2_SpeedY", Float) = 0.25
...
_TextureStatic ("TextureStatic", 2D) = "white" { }
_Color ("Color", Color) = (1,1,1,0)
_Ceilling ("Ceilling", Float) = 128
_TimeMultiplier ("TimeMultiplier", Float) = 128
_CloudBrightness ("CloudBrightness", Float) = 1
_GradientDarkness ("GradientDarkness", Float) = 1
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
SubShader {
