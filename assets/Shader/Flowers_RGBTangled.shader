...
//
///////////////////////////////////////////
Shader "Flowers/RGBTangled" {
Properties {
_TextureSample0 ("Texture Sample 0", 2D) = "white" { }
_RedTime ("RedTime", Float) = 1
_TimeAdd ("TimeAdd", Float) = 2
_ColorOverride ("ColorOverride", Color) = (0,0,0,0)
_VertexWeightY ("VertexWeightY", Float) = 0.1
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
SubShader {
