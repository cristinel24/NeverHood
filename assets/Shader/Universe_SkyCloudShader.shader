...
//
///////////////////////////////////////////
Shader "Universe/SkyCloudShader" {
Properties {
_Texture1 ("Texture1", 2D) = "white" { }
_Texture2 ("Texture2", 2D) = "white" { }
_CloudMultiplyTexture ("CloudMultiplyTexture", 2D) = "white" { }
_GradientAlbedo ("GradientAlbedo", 2D) = "white" { }
_TextureCloud_SpeedX ("TextureCloud_SpeedX", Float) = 0.25
_Texture2_SpeedX ("Texture2_SpeedX", Float) = 0.25
_Texture1_SpeedX ("Texture1_SpeedX", Float) = 0.25
_Texture2_TilingX ("Texture2_TilingX", Float) = 0.25
_Texture1_TilingX ("Texture1_TilingX", Float) = 0.25
_TextureCloud_TilingX ("TextureCloud_TilingX", Float) = 0.25
_Texture2_TilingY ("Texture2_TilingY", Float) = 0.25
_TextureCloud_TilingY ("TextureCloud_TilingY", Float) = 0.25
_Texture1_TilingY ("Texture1_TilingY", Float) = 0.25
_TextureCloud_OffsetX ("TextureCloud_OffsetX", Float) = 0.25
_Texture1_OffsetX ("Texture1_OffsetX", Float) = 0.25
_Texture2_OffsetX ("Texture2_OffsetX", Float) = 0.25
...
_TextureCloud_OffsetY ("TextureCloud_OffsetY", Float) = 0.25
_Texture1_OffsetY ("Texture1_OffsetY", Float) = 0.25
_Texture2_OffsetY ("Texture2_OffsetY", Float) = 0.25
_Gradient_MultiplyY ("Gradient_MultiplyY", Float) = 1
_TextureCloud_SpeedY ("TextureCloud_SpeedY", Float) = 0
_Texture2_SpeedY ("Texture2_SpeedY", Float) = 0
...
_CloudMultiplier ("CloudMultiplier", Float) = 1
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
SubShader {
