...
//
///////////////////////////////////////////
Shader "Everhood/JourneySpacetime" {
Properties {
_MasterColor ("MasterColor", Float) = 0
_StarSpeedX ("StarSpeedX", Float) = 0
_StarSpeedY ("StarSpeedY", Float) = 0
_StarTextureMultiply ("StarTextureMultiply", Float) = 0
_StarEmissive ("StarEmissive", Float) = 0
_CloudEmissive ("CloudEmissive", Float) = 0
_StarColors ("StarColors", Color) = (1,0,0,0)
_StarGradient ("StarGradient", Float) = 1
_StarTextureR ("StarTextureR", 2D) = "white" { }
_Cloud_TextureMultiply ("Cloud_TextureMultiply", Float) = 0
_CloudGTexture ("CloudGTexture", 2D) = "white" { }
_CloudSpeedX ("CloudSpeedX", Float) = 0
_CloudSpeedY ("CloudSpeedY", Float) = 0
_CloudColor ("CloudColor", Color) = (1,0,0,0)
_CloudGradient ("CloudGradient", Float) = 1
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
SubShader {
