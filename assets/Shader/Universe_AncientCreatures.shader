...
//
///////////////////////////////////////////
Shader "Universe/AncientCreatures" {
Properties {
...
_GradientFade ("GradientFade", Vector) = (0,0,0,0)
_TilingFade ("TilingFade", Vector) = (0,0,0,0)
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
SubShader {
 ...
 Pass {
  Name "FORWARD"
  Tags { "IsEmissive" = "true" "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Geometry+0" "RenderType" = "Transparent" "SHADOWSUPPORT" = "true" }
  GpuProgramID 34547
Program "vp" {
SubProgram "d3d11 " {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "FORWARD"
  Tags { "IsEmissive" = "true" "LIGHTMODE" = "FORWARDADD" "QUEUE" = "Geometry+0" "RenderType" = "Transparent" "SHADOWSUPPORT" = "true" }
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "ShadowCaster"
  Tags { "IsEmissive" = "true" "LIGHTMODE" = "SHADOWCASTER" "QUEUE" = "Geometry+0" "RenderType" = "Transparent" "SHADOWSUPPORT" = "true" }
  GpuProgramID 224636
Program "vp" {
SubProgram "d3d11 " {
