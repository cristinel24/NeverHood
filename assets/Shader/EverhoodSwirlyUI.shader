...
//
///////////////////////////////////////////
Shader "EverhoodSwirlyUI" {
Properties {
_Texture ("Texture", 2D) = "white" { }
_TextureOffsetX ("TextureOffsetX", Float) = 0
_TextureOffsetY ("TextureOffsetY", Float) = 0
_TextureMultiplierX ("TextureMultiplierX", Float) = 1
_TextureMultiplierY ("TextureMultiplierY", Float) = 1
_Metallic ("Metallic", Float) = 0
_Smoothness ("Smoothness", Float) = 0
_ColorRedChannel ("ColorRedChannel", Color) = (1,0,0,0)
_ColorGreenChannel ("ColorGreenChannel", Color) = (0.00126791,1,0,0)
_ColorBlueChannel ("ColorBlueChannel", Color) = (0,0,1,0)
_MasterColor ("MasterColor", Color) = (1,1,1,0)
_VertexMultiplierY ("VertexMultiplierY", Float) = 2
_VertexMultiplierX ("VertexMultiplierX", Float) = 1
_TimeMultiplierY ("TimeMultiplierY", Float) = 5
_TimeMultiplierX ("TimeMultiplierX", Float) = 1
_VertexWeightY ("VertexWeightY", Float) = 0.1
_VertexWeightX ("VertexWeightX", Float) = 0.1
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
SubShader {
