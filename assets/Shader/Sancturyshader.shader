...
//
///////////////////////////////////////////
Shader "Sancturyshader" {
Properties {
_Cutoff ("Mask Clip Value", Float) = 0.5
_Windows ("Windows", 2D) = "white" { }
_Gradient ("Gradient", Float) = 1
_Flash ("Flash", Float) = 2
_Color ("Color", Color) = (0,0.7579308,1,0)
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
SubShader {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "ShadowCaster"
  Tags { "IsEmissive" = "true" "LIGHTMODE" = "SHADOWCASTER" "QUEUE" = "Geometry+0" "RenderType" = "TransparentCutout" "SHADOWSUPPORT" = "true" }
  Cull Off
  GpuProgramID 215722
Program "vp" {
SubProgram "d3d11 " {
